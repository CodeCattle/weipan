                    ...
                    <div class="col-md-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-title">
                                <h5>会员类型<small> 添加</small></h5>
                            </div>
                            <!-- 定义内容 -->
                            <div class="ibox-content">
                                <form method="post" class="form-horizontal" action="sys/dir/add" id="dirForm">
                                   <div class="form-group">
                                        <label class="col-sm-2 control-label">上传者序号:</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="user_id" id="user_id" class="form-control" autofocus="autofocus">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">文件夹名称:</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="dir_name" id="dir_name" class="form-control" autofocus="autofocus">
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label class="col-sm-2 control-label">文件夹描述:</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="dir_remark" id="dir_remark" class="form-control">
                                        </div>
                                    </div>
