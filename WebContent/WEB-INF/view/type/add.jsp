                    ...
                    <div class="col-md-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-title">
                                <h5>会员类型<small> 新增</small></h5>
                            </div>
                            <!-- 定义内容 -->
                            <div class="ibox-content">
                                <form method="post" class="form-horizontal" action="sys/type/add" id="typeForm">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">类型名称</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="type_name" id="type_name" class="form-control" autofocus="autofocus" placeholder="请输入类型名称">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">单文件大小:</label>
                                        <div class="col-sm-4">
                                            <input type="number" name="file_size" id="file_size" class="form-control" placeholder="请输入单文件大小">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">总文件大小:</label>
                                        <div class="col-sm-4">
                                            <input type="number" name="max_size" id="max_size" class="form-control" placeholder="请输入总文件大小">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">价格(月):</label>
                                        <div class="col-sm-4">
                                            <input type="number" name="money" id="money" class="form-control" placeholder="请输入价格">
                                        </div>
                                    </div>
